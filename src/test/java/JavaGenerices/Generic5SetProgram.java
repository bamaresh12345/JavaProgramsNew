...
import java.util.*;
/*  IMP List methods
     set.add("Ram");     set.add(i)
     set.remove("Sam")
     set.contains("sdf")  --. ** IMP    list.contains(234)  // true or false
     set.size()
     set.clear()  %%%%%%%%%%%%%
      list.get(index); --> for loop to get the values
     set.toArray()
...
//=========================================================================================
        ...
        . LinkedHashSet
          ...
          2. TreeSet
            Order: Insertion order is preserved but Sorted in natural order (or custom order via Comparator)
            Duplicates: Not allowed
