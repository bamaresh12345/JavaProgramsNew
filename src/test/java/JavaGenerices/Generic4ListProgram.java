...
/*  IMP List methods
     ...
     list.remove("Sam")
     list.contains("sdf")  --. ** IMP    list.contains(234)  // true or false
     list.size()
     list.clear()  %%%%%%%%%%%%%
     list.set(2,"test");    //
...
public class Generic4ListProgram {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" arr.length " + arr.length); // for ARRAY
        System.out.println("list.size()  " + list.size()); // for LIST
