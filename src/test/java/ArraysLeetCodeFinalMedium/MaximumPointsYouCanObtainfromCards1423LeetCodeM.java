 ...
 */
public class MaximumPointsYouCanObtainfromCards1423LeetCodeM {

    public static int MaximumPointsYouCanObtainfromCards(int[] nums, int k) {
    ...
    public static void main(String[] args) {
        ...
        int k = 3;
        System.out.println(MaximumPointsYouCanObtainfromCards(nums, k));
    }
}
