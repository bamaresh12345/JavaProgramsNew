...
public class CountCharsRepeatedWorDay {
    ...
    // ****** EASY ONE  SAME as Remove Duplicate from Integer Array Logic*****
    public static void CountCharsRepeated2(String str)
    {
        int count=1;
        String val = "";
        char ch='0';
        ...
        for (int i=0; i<chars.length; i++)
        {
            ...
            {
                val = val+""+chars[i] + count;   // "" is IMP*** and Val and chars[i] is IMP***
