...
public class FristUniqueCharacterInStringIMPlt387 {
    ...
    public static int fristUniqueCharacterInString(String s) {
        ...
        for (int i = 0; i < s.length(); i++) { // same s.length() loop
        ...
        for (int i = 0; i < s.length(); i++) {
            char c = s.charAt(i);
            if (freq[c - 'a'] == 1)   // Very IMP**** // Very IMP****
                return i;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(fristUniqueCharacterInStringMaps(s));

    }

    //public static int fristUniqueCharacterInStringMaps(String s) {
    public static char fristUniqueCharacterInStringMaps(String s) {
